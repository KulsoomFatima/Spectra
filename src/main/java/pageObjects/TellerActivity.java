...
public class TellerActivity extends base {
	...
	public TellerActivity() throws SQLException {
	...
	public void tellerdailytable() throws InterruptedException, SQLException {
	 ...
	 TellerActivity_database gdata=new TellerActivity_database();
			
			String i=gdata.tellerdailytable();

...
public class serviceBranches extends base {
	...
	public serviceBranches() throws SQLException {
	...
	@Test
	public void branchestable() throws InterruptedException, SQLException {
   	 ...
   	 WebElement tableRow = table.findElement(By.xpath("//div[@class='table-responsive border-radius-xs']//div//table//tbody//tr"));
     String rowtext = tableRow.getText();
	 System.out.println("row of table : "+rowtext);
	 
		//sending ST to database class
	 serviceBranches_database gdata=new serviceBranches_database();
			
			String i=gdata.branchestable();
	...
	@Test
	public void branchrecord() throws InterruptedException, SQLException {
	...
	@Test
	public void branchgraph() throws InterruptedException, SQLException {
		...
		Thread.sleep(5000);
		  ...
		  List<WebElement> graphlist = 
					 driver.findElements(By.xpath("//*[name()='svg']/*[name()='g']"));

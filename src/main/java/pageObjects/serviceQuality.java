...
public class serviceQuality extends base {
	...
	public serviceQuality() throws SQLException {
	...
	@Test
	public void qualitytable() throws InterruptedException, SQLException {

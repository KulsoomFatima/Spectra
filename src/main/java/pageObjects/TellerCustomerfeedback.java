...
public class TellerCustomerfeedback extends base {
	...
	public TellerCustomerfeedback() throws SQLException {
	...
	@Test
	public void tellercustomerfeedbacktable() throws InterruptedException, SQLException {
		...
		driver.findElement(By.xpath("//ul[@class='nav big-tabs nav-tabs']//li[7]")).click();
	 ...
	 TellerCustomerfeedback_database gdata=new TellerCustomerfeedback_database();
			
			String i=gdata.tellercustomertable();
	...
	TellerCustomerfeedback_database gdata=new TellerCustomerfeedback_database();
		...
		String i=gdata.tellercustomersummary();
		System.out.println(i);
